...
class process_links:
    ...
    def process_info(self, servings, titles, ingredients, nutrients, instructions):
    ...
    def get_ingredients_from_groups(self,ingredient_groups):
        ...
        for g in ingredient_groups:
            ...
            ingredient_per_group["Category"] = group_name
            ingredient_per_group["ingredients"] = []
            ...
            for i in range(len(ingredient_list)):
                ...
                ingredient_per_group["ingredients"].append(f"{amount} {name}")
...
if __name__ == "__main__":
    ...
    data_frame = pl.process_info(*pl.extract_info(links))
    print("Finished processing links, constructing data set...")
    data_frame.to_csv("processed_info.csv", index=False)
