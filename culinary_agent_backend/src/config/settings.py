...
# Data files
RECIPE_EMBEDDINGS_FILE = PROJECT_ROOT / "recipes_for_embeddings.jsonl"
FULL_RECIPES_FILE = PROJECT_ROOT / "full_format_recipes.json"
FAISS_INDEX_FILE = PROJECT_ROOT / "recipe_index.faiss"
